(function(){{
    ...
    var i, j, ret, matched, handleObj, handlerQueue = [], args = slice.call(arguments), handlers = (data_priv.get(        $that, 'events') || {})[event.type] || [], special = jQuery.event.special[event.type] || {};
