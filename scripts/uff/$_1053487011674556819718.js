(function(){{
    var $ = require('$'), Widget = require('lavaca/ui/Widget'), Promise = require('lavaca/util/Promise');
   ...
   */
     ...
     */
        onSubmit: function (e) {
            e.preventDefault();
            this.validate().success(this.onSubmitSuccess).error(this.onSubmitError);
        },
        /**
     ...
     */
        onChangeInput: function (e) {
            if (this.model) {
                var input = $(e.target), name = input.attr('name'), value = input.val();
     ...
     */
        values: function () {
            var inputs = this.el.find('input, select, textarea'), result = {}, i = -1, input, name, current, value, type;
     ...
     */
        validate: function (success, error, input) {
            ...
            var result = null, promise = new Promise(this), i = -1, j, rule, inputs, ip, message, name, label, id, value;
            ...
            return promise.error(function (inputs) {
