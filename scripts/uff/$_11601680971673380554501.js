(function(){{
   ...
   */
     ...
     */
        then: function (resolved, rejected) {
            return this.success(resolved).error(rejected);
        },
        /**
     ...
     */
        when: function () {
            var self = this, values = [], i = -1, pendingPromiseCount = arguments.length, promise;
            while (!!(promise = arguments[++i])) {
                (function (index) {
                    promise.success(function (v) {
                        values[index] = v;
   ...
   * @return {Lavaca.util.Promise}  The new promise
   */
    Promise.when = function (thisp) {
        var thispIsPromise = thisp instanceof Promise, promise = new Promise(thispIsPromise ? window : thisp), args = [].slice.call(arguments, thispIsPromise ? 0 : 1);
