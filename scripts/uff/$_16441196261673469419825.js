(function(){{
    var Route = require('./Route'), History = require('lavaca/net/History'), Disposable = require('lavaca/util/Disposable'), Promise = require('lavaca/util/Promise');
    /**
   ...
   */
     ...
     */
        exec: function (url, state, params) {
            ...
            var i = -1, route, promise = new Promise(this);
